...
export default function Landing() {
  ...
  return (
    <>
      ...
      <Modal open={donateOpen} onClose={() => setDonateOpen(false)} title={t("donate.title")}>
        <div className="space-y-4 text-sm text-gray-700">
          <ol className="list-decimal space-y-2 pl-5">
            ...
            <li>
              ...
              >
                <span dir="ltr">{DONATE_RECEIPT_PHONE}</span>
              </a>
            </li>
          </ol>
          ...
          <div className="rounded-xl border bg-gray-50 p-4">
            ...
            <div className="mt-1 flex items-center justify-between gap-2">
              <p className="text-gray-600">
                {t("donate.ibanLabel")}: <span dir="ltr" className="font-mono font-medium text-gray-900">{DONATE_IBAN}</span>
              </p>
              <button
                type="button"
                onClick={copyIban}
